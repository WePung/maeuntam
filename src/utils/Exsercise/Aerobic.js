export const Aerobic = [
  ...
  },
  {
    ...
    src: "https://www.youtube.com/embed/8ki9cCy4Kko",
    step: [
      {
        key: 1,
        description: "줄넘기 줄을 명치 높이로 맞춰줍니다.",
      },
      {
        key: 2,
        description: "줄을 돌리며 타이밍에 맞춰 앞꿈치로 점프를 해줍니다.",
      },
      {
        key: 3,
        description:
          "목표 갯수의 1/10 가량을 연속으로 하는 것을 목표로 설정하여 진행 합니다.",
      },
    ],
  },
  {
    ...
    src: "https://www.youtube.com/embed/K10SQGT-W1Q",
    step: [
      {
        key: 1,
      ...
      {
        key: 2,
        description: "손으로 땅을 짚고 다리를 뒤로 보내 엎드려 줍니다",
      },
      {
        key: 3,
        description: "다리를 다시 가져온 후 일어서 줍니다",
      },
    ],
  },
  {
